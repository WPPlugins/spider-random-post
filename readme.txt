...
Donate link: https://web-dorado.com/products/wordpress-random-post.html  
...
== Description ==  
Display random posts on the sidebar from the same category. You can choose the number of posts and the different effects available. Try for free!   
  
Spider [Random Post](https://web-dorado.com/products/wordpress-random-post.html)  
...
###If you want to have possibility to choose the particular category of posts to display randomly, you can buy the commercial version [here.](https://web-dorado.com/products/wordpress-random-post.html)    
  
    
  
###Features of Spider  [Random Post](https://web-dorado.com/products/wordpress-random-post.html)  
...
####Thank you for your interest in Spider [Random Post](https://web-dorado.com/products/wordpress-random-post.html).  
...
If any problem occurs with Spider [Random Post](https://web-dorado.com/products/wordpress-random-post.html), please contact us info@web-dorado.com.  

== Spider Random Post user manual==        
    
###Step by step guide for Spider [Random Post](https://web-dorado.com/products/wordpress-random-post.html)  
